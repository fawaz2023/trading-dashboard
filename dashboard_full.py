    ...
    with tab3:
        ...
        if os.path.exists(FLEXGATE_FILE):
            ...
            if len(df_flex) > 0:
                ...
                capital = 1000000.0
                risk_per_trade = capital * 0.002 # 2000
